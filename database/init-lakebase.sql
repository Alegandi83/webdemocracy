-- ============================================================================
-- Web Democracy - Databricks Lakebase Initialization Script
-- Versione: 2.1
-- Data: 27 Ottobre 2025 (Corrected)
-- ============================================================================
-- IMPORTANTE: Databricks Lakebase è PostgreSQL-compatibile!
-- Usa la stessa sintassi SQL di PostgreSQL standard (porta 5432)
-- NON è Databricks SQL Warehouse (quello usa porta 443 e sintassi diversa)
-- ============================================================================
...
BEGIN
    RAISE NOTICE '';
    RAISE NOTICE '========================================';
    RAISE NOTICE 'Web Democracy Database Initialized on Lakebase!';
    RAISE NOTICE '========================================';
    RAISE NOTICE 'Tables created: 8';
    RAISE NOTICE 'Sample surveys: 6';
    RAISE NOTICE 'Tags: 8';
    RAISE NOTICE 'Version: 2.1';
    RAISE NOTICE 'Platform: Databricks Lakebase (PostgreSQL-compatible)';
    RAISE NOTICE '========================================';
    RAISE NOTICE '';
END $$;
